                ...
                <div class="row">
                    <div class="col-lg-4 col-md-8 col-12 mx-auto">
                        <div class="card z-index-0 fadeIn3 fadeInBottom">
                            ...
                            <div class="card-body">
                                <?php if (!isset($_COOKIE['jwt'])) { ?>
                                    <form name="form" method="POST" action="prosesLogin.php" role="form" class="text-start">
                                        ...
                                        <p class="mt-4 text-sm text-center">
                                            ...
                                            <a href="register.php" class="text-primary text-gradient font-weight-bold">Sign
                                                up</a>
                                        </p>
                                    </form>
                                <?php } else { ?>
