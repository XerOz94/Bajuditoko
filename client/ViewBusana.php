...
<?php if (isset($_COOKIE['jwt'])) { ?>
  ...
  <body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <div class="container-fluid py-1 px-3">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
              ...
              <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Data Busana</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">Data Busana</h6>
          </nav>
        </div>
      </nav>
      <!-- End Navbar -->
      <!-- BODY -->
      <form action="prosesBusana.php" method="POST" name="form" class="px-4 py-4">
        <h2>Tambah Busana</h2>
        <p>Isi informasi berikut untuk setiap Busana:</p>
        <div class="row" id="alternatif-container">
          <!-- Kolom pertama -->
          <div class="col-md-4">
            <div class="input-group input-group-outline my-3">
              <input type="hidden" name="aksi" value="tambah" />
              <label class="form-label">Id Busana</label>
              <input type="text" name="id_busana" class="form-control">
            </div>
          </div>
          <!-- Kolom kedua -->
          <div class="col-md-4">
            <div class="input-group input-group-outline my-3">
              ...
              <!-- <label for="id_brand" class="ms-0">Brand</label> -->
          ...
          <div class="col-md-4">
            <div class="input-group input-group-outline my-3">
              ...
              <input type="text" name="nama_busana" class="form-control">
            </div>
          </div>
          <div class="col-md-4">
            <div class="input-group input-group-outline my-3">
              <label class="form-label">Gambar busana</label>
      ...
      <div class="card mx-4">
        <div class="text-uppercase text-white bg-gradient-primary font-weight-bolder ps-3 card-header">Data busana
        </div>
          ...
          <table class="table align-items-center mb-0">
            <thead>
              <tr>
                ...
                <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-3">Id busana</th>
            ...
            <tbody>
              ...
              foreach ($data_array as $r) {
                    ...
                    <p class="text-xs font-weight-bold mb-0">
                      <a href="#">
                        <button type="button" class="btn btn-sm bg-gradient-warning" data-bs-toggle="modal"
                          data-bs-target="#editModal<?= $r->id_busana ?>" name="ubah" data-id="<?= $r->id_busana ?>">
                          Edit
                        </button>
                      </a>
                      <a href="prosesBusana.php?aksi=hapus&id_busana=<?= $r->id_busana ?>"
                ...
                <!-- Modal -->
                <div class="modal fade" id="editModal<?= $r->id_busana ?>" tabindex="-1" role="dialog"
                  aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title font-weight-normal" id="exampleModalLabel">Edit busana</h5>
                          ...
                          <div class="row" id="alternatif-container">
                            ...
                            <div class="col-md-6">
                              <div class="input-group input-group-outline my-3">
                                ...
                                <input type="hidden" id="id_busana_input" />
                                <label class="form-label">Id busana</label>
                                <input type="text" name="id_busana" class="form-control" value="<?= $r->id_busana ?>"
                                  readonly />
                              </div>
                            </div>
                            <!-- Kolom kedua -->
                            ...
                            <div class="col-md-6">
                              <div class="input-group input-group-outline my-3">
                                <label class="form-label">Nama busana</label>
                                <input type="text" name="nama_busana" class="form-control" value="<?= $r->nama_busana ?>">
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="input-group input-group-outline my-3">
    ...
    <script>
      $(document).ready(function () {
        $('#editModal').on('show.bs.modal', function (e) {
          var idbusana = $(e.relatedTarget).data('id');
          $('#id_busana_input').val(idbusana);
