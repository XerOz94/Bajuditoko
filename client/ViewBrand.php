...
<?php if (isset($_COOKIE['jwt']) && $_COOKIE['role'] == 'Admin') { ?>
  ...
  <body class="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <!-- End Navbar -->
      <!-- BODY -->
      <form action="prosesBrand.php" method="POST" name="form" class="px-4 py-4">
        <h2>Tambah Brand</h2>
      ...
      <div class="card mx-4">
        <div class="text-uppercase text-white bg-gradient-primary font-weight-bolder ps-3 card-header">Data Brand
        </div>
        <div class="table-responsive">
          <table class="table align-items-center mb-0">
            ...
            <tbody>
              <?php
              $no = 1;
              $data_array = $abc->tampil_semua_dataBrand();
                ...
                <tr>
                  ...
                  <td>
                    <p class="text-xs font-weight-bold mb-0">
                      ...
                      <a href="prosesBrand.php?aksi=hapus&id_brand=<?= $r->id_brand ?>"
